...
<head>
    ...
    <title>Order Notification | Shopalot eCommerce</title>
</head>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mt-5" style="margin-top: 35px; display: flex;">
                        <div class="col-6"
                            ...
                            <b><?php echo e($order->first_name . ', ' . $order->last_name); ?></b>
                            <br>
                            <span>
                                <a style="color: white !important;" href="mailto:<?php echo e($order->email); ?>" target="_blank"><?php echo e($order->email); ?></a>
                            </span>
                            <br>
                            <span><?php echo e($order->phone); ?></span>
                        </div>
                        <div class="col-6" style="flex: 0 0 50%; width: 50%; box-sizing: border-box;">
                            <b>Order date:</b> <?php echo e(date('d/m/yy H:i', strtotime($order->created_at))); ?>

                            <br>
                            <b>Address:</b> <?php echo e($order->street_address . ' - ' .  $order->town_city); ?>
            ...
            <div class="row mt-2 p-4" style="background-color: white; margin-top: 15px; padding: 20px;">
                <table>
                    <tr>
                        ...
                        <?php if($order->payment_type == "pay_later"): ?>
                        ...
                        <?php if($order->payment_type == "online_payment"): ?>
                            <td class="pl-3" style=" padding-left:15px;">
                                <span class="d-inline"
                                      style="color:#424853; font-family:trebuchet,sans-serif; font-size:16px; font-weight:normal; line-height:22px;">
                            ...
                            <?php $__currentLoopData = $order->orderDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orderDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td style="border-top: 1px solid #dee2e6; padding: 5px 0;">
                                        <?php echo e($orderDetail->product->name . ' (x' . $orderDetail->qty . ')'); ?>

                                    </td>
                                    <td style="border-top: 1px solid #dee2e6; padding: 5px 20px 5px 0; text-align: right;">
                                        <?php echo e($orderDetail->total); ?> $
                                    </td>
                                </tr>
...
<?php /**PATH D:\Project\shopalot_eshop\resources\views/front/checkout/email.blade.php ENDPATH**/ ?>