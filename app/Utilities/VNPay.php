...
class VNPay
{
     ...
     *
     */
    static $vnp_TmnCode = "S9OKYBQ0"; //Mã website tại VNPAY
    static $vnp_HashSecret = "6CFJPBITBIKX8CWCWUIERLQMF8WGVFF6"; //Chuỗi bí mật
...
//        $vnp_BankCode = 'NCB';
        ...
        //thêm 'vnp_SecureHashType' & 'vnp_SecureHash'sh
