...
class ShopController extends Controller
{
    ...
    public function category($categoryName, Request $request): \Illuminate\Foundation\Application|\Illuminate\Contracts\View\Factory|\Illuminate\Contracts\View\View
    {
        $categories = $this->productCategoryService->all();
